...
- [x] 7. Test carousel integration
  - [x] 7.1 Test carousel navigation and display
  ...
  - [x] 7.2 Test carousel-graph synchronization
  ...
  - [x] 7.3 Verify all external links work
...
- [x] 8. Cross-browser and responsive testing
  - [x] 8.1 Test on desktop browsers
